...
**Why selection discipline matters (the sobering data):** MIT's 2025 *"GenAI Divide: State of AI in Business"* found that despite an estimated $30–40B in enterprise GenAI spend, **~95% of organizations reported no measurable P&L return** — attributing failure to the integration/"learning gap" (tools that don't retain feedback or fit workflows), **not** model quality. *(Flag: this measures pilots lacking measurable ROI, not technical failure, on a modest sample — cite as "no measurable ROI," not "failed.")* McKinsey's 2025 *State of AI* similarly found only **~39% report any enterprise EBIT impact**, most attributing <5% — the "scaling gap." The lesson: value comes from disciplined selection + workflow integration, not from the model.
...
**(a) What it is / why it matters.**
Technology adoption is a **people** problem. The largest AI ROI comes not from bolting a copilot onto an unchanged process, but from **redesigning the workflow** around what AI now makes cheap — and bringing people along. Ignore this and you get expensive shelfware with 5% adoption. BCG's long-standing framing quantifies it: roughly **70% of AI value comes from people and process change, ~20% from tech/data, ~10% from the algorithms** *(a reused heuristic, not a fresh survey — cite as BCG's framing)*; BCG's 2025 work also found only ~5% of firms are "future-built" value generators while ~60% are laggards.
...
- **Over-automation too soon** — autonomous high-stakes actions before trust/guardrails/evals exist (Module 5.7). Real cases: **Klarna** publicly reversed its AI-replaces-agents strategy in 2025 and rehired humans after quality dropped; **McDonald's** ended its AI drive-thru pilot and **Taco Bell** scaled its back after edge-case failures (the "18,000 waters" incident) — the demo-to-production gap made concrete.
- **Agent-washing / premature autonomy hype** — Gartner (2025) projects **>40% of agentic AI projects will be canceled by end-2027** on cost/value/risk grounds, and warns of "**agent washing**" (rebranded chatbots/RPA sold as agents). Buy real capability, not the label; pilot with a value/risk gate.
